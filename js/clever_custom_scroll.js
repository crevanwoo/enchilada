...
function setRunnerSize() {   
    ...
    console.log(define_container_height(container));
      console.log(define_wrapper_height(container));
    if(define_container_height(container) <= define_wrapper_height(container)) {
      
                                                                                
        defineThumb().parentElement.style.display = "none"}
};